...
local Window = OrionLib:MakeWindow({Name = "Banana Hub - HaToKi Ăn Cắp",IntroText = "Banana-HaToKi Dev"})
...
local FolderName = "Banana Hub Bị Bố Dec"
...
function HopServer()
    ...
    v14.new("<Color=Red>Banana Bị Bố Dec : Wait "..(tostring(Settings["Delay HopServer"]) or "15").."s[Hop Server]<Color=/>"):Display()
...
Tab2:AddToggle({
	...
	Callback = function(Value)
        ...
        if Value then
            OrionLib:MakeNotification({
                Name = "Banana Hub - Bị Bố HaToKi Dec",
